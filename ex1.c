...
int main (int argc, char *argv[])
{
      ...
      of the grid that it owns. */
   {
      ...
      if (myid == 0)
      {
         int ilower[2]={1,1}, iupper[2]={4,8};
         HYPRE_StructGridSetExtents(grid, ilower, iupper);
      }
      else if (myid == 1)
      {
         int ilower[2]={5,1}, iupper[2]={8,8};
         HYPRE_StructGridSetExtents(grid, ilower, iupper);
      }
   ...
   /* 3. Set up a Struct Matrix */
   {
      ...
      if (myid == 0)
      {
         ...
         int stencil_indices[5] = {0,1,2,3,4}; /* labels for the stencil entries -
                                                  ...
                                                  defined above */
         int nentries = 5;
         int nvalues  = 160; /* 32 grid points, each with 5 stencil entries */
         double values[160];
      ...
      corresponding to its boxes. */
   {
      ...
      {
         int ilower[2]={1,1}, iupper[2]={4,8};
         double values[32]; /* 32 grid points */
